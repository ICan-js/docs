...
\section{Inteligência artificial} % Reescrever

% Verificar a necessidade de escrever sobre inteligência artificial! ! !
...
Redes neurais artificiais (RNA) são sistemas computacionais que busca modelar o sistema cerebral natural humano, estas que são uma das formas de soluções de problemas apresentados dentro do âmbito de inteligência computacional (CINTRA, 2015).
