...
% ToDo: Fazer a explicação das deficiências e dos recursos assistivos
% \textbf{CONVERSANDO COM O ORIENTADOR, ESTA SEÇÃO SERÁ ESCRITA JÁ EXPLICANDO AS DEFICIÊNCIAS E TAMBÉM OS RECURSOS ASSISTIVOS}
...
% Estou com dúvida sobre onde deixar este tópico aqui...
...
% \textbf{O QUE É ESTE LINK MALUCO!!! ESTÁ ERRADO ISTO!!!!}
...
\image{0.6}{posenet_poses_original.png}{Pontos identificados pelo PoseNet}{figure:posenet_poses}{Adaptado de \citeonline{PoseNetMedium2019}}
...
% 19/03/2019 -> Bem, ao ler novamente o capítulo, o pensamento do carlos voltou em mim, parece que estou explicando menos do necessário e mais sobre o que está sendo feito

Esta seção demonstra as tecnologias utilizadas durante a desenvolvimento do presente trabalho.

\subsection{Linguagens de Programação}

% \textbf{BEM, ACHO QUE NESTE CAPÍTULO ESTOU ESTOU EXPLICANDO MENOS SOBRE O QUE SÃO AS TECNOLOGIAS E MAIS SOBRE ONDE É UTILIZADO, DA MESMA FORMA DITA PELO CARLOS, A MUDANÇA É MAIS QUE NECESSÁRIA AQUI}

% \textbf{HEY! FALAR AQUI SOBRE O AUGMENTOR! ELE ESTÁ SENDO EXPLICADO LÁ EM BAIXO!!!!}

% \textbf{SERÁ NECESSÁRIO REVER TODOS O TEXTO E ENTÃO MOVER AS EXPLICAÇÕES PARA CÁ}
...
% \textbf{OLHA ISTO AQUI! O NODE.JS NEM É CITADO!!! VOCÊ DEVE COLOCAR ELE AQUI, EXPLICAR O RUNTIME E O TRANSPILE....}
\par Para o desenvolvimento da biblioteca de recursos assistivos, fez-se a utilização da linguagem de programação JavaScript, no ambiente de execução Node.js, junto a biblioteca de desenvolvimento de Aprendizado Profundo para \textit{web} Tensorflow.js (TFJS), que permite a utilização de modelos de rede neural em navegadores, além de possuir diversos modelos já implementados \cite{tensorflowjs2019}.
