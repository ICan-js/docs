...
%%%%%%%%%%%%Listings das linguagens utilizadas
...
% Define a linguagem JavaScript no pacote listings
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, async, await},
